...
Instalar Godot Engine 4.6.2 o superior.
Abrir Godot → Importar → seleccionar la carpeta del repositorio (donde está project.godot).
Ejecutar la escena principal (TestLevel.tscn) para probar el prototipo.
👤 Autor
Emiliano Arias
